...
APP.write_text(s)
i=INDEX.read_text(); i=i.replace('styles.css?v=41.9','styles.css?v=41.10').replace('app.js?v=41.9','app.js?v=41.10')
...
anchor="assert.match(css, /audio-to-text-svg/);\n"
