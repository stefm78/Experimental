...
/**
 * Turn-level transcript authority independent from SpeechRecognizer sub-session lifetime.
 * This is the product-host extraction of the V3 lossless stitching accumulator from PR #100.
 */
