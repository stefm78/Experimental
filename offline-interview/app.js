const BUILD_ID = '2026-09-01.android-diag-v13';
...
async function registerServiceWorker() {
  ...
  diagEvent('service-worker', 'START', './sw.js?v=13');
  try {
    ...
    ui.diagSw.textContent = controllerUrl?.includes('v=12') ? 'actif · v13' : (reg.active ? 'actif' : 'installé');
...
async function prepareModel() {
  ...
  try {
    ...
    // Ensure the fixed v13 service worker is controlling before Transformers
